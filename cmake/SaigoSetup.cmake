...
if (NOT CLONE_SHARED_REPOSITORIES)
	...
	set(CONFIGURE_PROGRAM_PREFIX "${SAIGO_SYSTEM_NAME}-")

	list(GET SAIGO_ARCH_NAMES 0 SAIGO_PRIMARY_ARCH_NAME)
	set(TRIPLE_TARGET "${SAIGO_PRIMARY_ARCH_NAME}-${SAIGO_SYSTEM_NAME}")

	foreach(archName IN LISTS SAIGO_ARCH_NAMES)
		list(APPEND TRIPLE_TARGETS "${archName}-${SAIGO_SYSTEM_NAME}")
	endforeach()

	list(JOIN TRIPLE_TARGETS "," CONFIGURE_TRIPLE_TARGETS)
